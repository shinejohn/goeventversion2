-- FIXED SQL - Uses correct table name "communities" not "community_hubs"

-- Step 1: Insert into the correct "communities" table
INSERT INTO public.communities (id, name, description, slug) VALUES 
