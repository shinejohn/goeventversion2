...
export type EntityCategory<T extends EntityType> = keyof typeof DEFAULT_IMAGES[T];

/**
 * Get the default image for an entity type and optional category
 */
export function getDefaultImage<T extends EntityType>(
  entityType: T,
  category?: string
): string {
