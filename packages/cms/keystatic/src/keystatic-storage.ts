 ...
 *
 * This can be provided through the `KEYSTATIC_STORAGE_KIND` environment variable or 'VITE_KEYSTATIC_STORAGE_KIND'.
 ...
 */
const STORAGE_KIND =
  import.meta.env.VITE_KEYSTATIC_STORAGE_KIND ??
  /* @deprecated */
 ...
 * This can be provided through the `VITE_KEYSTATIC_STORAGE_REPO` environment variable. The previous environment variable `KEYSTATIC_STORAGE_REPO` is deprecated.
 */
const REPO =
