...
> = ({
  ...
  const collapsibleStyle = import.meta.env.VITE_SIDEBAR_COLLAPSIBLE_STYLE;
  ...
  const setOpen = React.useCallback(
    (value: boolean | ((value: boolean) => boolean)) => {
      ...
      document.cookie = `${SIDEBAR_COOKIE_NAME}=${btoa(open.toString())}; path=/; max-age=${SIDEBAR_COOKIE_MAX_AGE}`;
    },
    [setOpenProp, open],
  );
