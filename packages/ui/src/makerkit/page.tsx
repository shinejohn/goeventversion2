...
const ENABLE_SIDEBAR_TRIGGER =
  import.meta.env.VITE_ENABLE_SIDEBAR_TRIGGER === 'true';
    ...
    <div className={cn('flex min-w-0 flex-1', props.className)}>
      ...
      <div
        className={
          ...
          'mx-auto flex h-screen w-full flex-col overflow-y-auto bg-inherit px-4 lg:px-0'
        }
      >
        {MobileNavigation}
...
export function PageTitle(props: React.PropsWithChildren) {
  return (
    <h1
      className={
        'font-heading h-6 text-lg leading-none font-bold tracking-tight dark:text-white'
      }
    >
      {props.children}
    </h1>
