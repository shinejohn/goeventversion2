-- FINAL WORKING SQL - Communities table also needs location field

-- Step 1: Insert into communities table with location
INSERT INTO public.communities (id, name, description, slug, location) VALUES 
('00000000-0000-0000-0000-000000000001', 'Default Community', 'Default community for testing', 'default-community', ST_GeomFromText('POINT(-74.0059 40.7128)', 4326))
ON CONFLICT (id) DO NOTHING;

-- Step 2: Insert 12 venues 
