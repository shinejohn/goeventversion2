-- =====================================================
-- SIMPLE DATABASE REPORT (WORKING VERSION)
-- =====================================================
...
-- 9. SIMPLE RECORD COUNT
SELECT '---' as separator;
SELECT 'RECORD COUNTS:' as info;
SELECT 'Run these separately to check record counts:';
SELECT '-- SELECT COUNT(*) FROM public.accounts;' as query;
SELECT '-- SELECT COUNT(*) FROM public.venues;' as query;
SELECT '-- SELECT COUNT(*) FROM public.events;' as query;