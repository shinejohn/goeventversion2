...
const magicPatternsDashboardLayout = layout('routes/layouts/magic-patterns-dashboard.tsx', [
  ...
  route('home/settings', 'routes/home/settings.tsx'),
  route('home/billing', 'routes/home/billing.tsx'),
  route('home/billing/return', 'routes/home/billing-return.tsx'),
  ...
  route('home/:account/billing/return', 'routes/home/account/billing-return.tsx'),
...
// Magic Patterns Admin Layout (if needed)
...
const bookingFlowLayout = layout('routes/layouts/booking-flow.tsx', [
  route('book', 'routes/book/index.tsx'),
...
const testRoutes = process.env.NODE_ENV === 'development' ? [
