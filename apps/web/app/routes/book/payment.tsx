// apps/web/app/routes/book/payment.tsx
import type { Route } from '~/types/app/routes/book/payment/+types';
...
export const action = async ({ request }: Route.ActionArgs) => {
  ...
  try {
    ...
    return redirect(`/book/review?bookingId=${bookingId}`);
...
export default function ContactPaymentFormRoute({ loaderData, actionData }: Route.ComponentProps) {
