-- =============================================================================
-- COMPREHENSIVE SEED DATA FOR ALL MAGIC PATTERNS TABLES
-- 12 records for EVERY table with proper images
-- =============================================================================

-- Ensure we have test account
DO $$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM public.accounts WHERE email = 'test@example.com') THEN
    INSERT INTO public.accounts (id, name, email, is_personal_account) 
    VALUES ('00000000-0000-0000-0000-000000000001'::uuid, 'Test Account', 'test@example.com', true);
  END IF;
END $$;

-- =============================================================================
-- VENUES DATA (12 records) - All with images and gallery_images
-- =============================================================================

INSERT INTO public.venues (
  id, account_id, name, description, venue_type, address, city, state, country, 
  postal_code, max_capacity, image_url, gallery_images, base_hourly_rate, 
  contact_email, contact_phone, slug, is_verified, is_active
) VALUES
...
('10000000-0000-0000-0000-000000000002'::uuid, '00000000-0000-0000-0000-000000000001'::uuid,
 ...
 '["https://images.unsplash.com/photo-1493225457124-a3eb161ffa5f", "https://images.unsplash.com/photo-1514525253161-7a46d19cd819", "https://images.unsplash.com/photo-1470229722913-7c0e2dbbafd3"]'::jsonb,
 300.00, 'info@bluenote.com', '+1-555-0102', 'blue-note-jazz', true, true),
...
('10000000-0000-0000-0000-000000000003'::uuid, '00000000-0000-0000-0000-000000000001'::uuid,
 ...
 '["https://images.unsplash.com/photo-1519167758481-83f550bb49b3", "https://images.unsplash.com/photo-1505373877841-8d25f7d46678", "https://images.unsplash.com/photo-1540039155733-5bb30b53aa14"]'::jsonb,
 750.00, 'events@crystalballroom.com', '+1-555-0103', 'crystal-ballroom', true, true),
...
('10000000-0000-0000-0000-000000000004'::uuid, '00000000-0000-0000-0000-000000000001'::uuid,
 ...
 '["https://images.unsplash.com/photo-1533174072545-7a4b6ad7a6a3", "https://images.unsplash.com/photo-1506905925346-21bda4d32df4", "https://images.unsplash.com/photo-1551698618-1dfe5d97d256"]'::jsonb,
 1200.00, 'booking@sunsetamphitheater.com', '+1-555-0104', 'sunset-amphitheater', true, true),
...
('10000000-0000-0000-0000-000000000005'::uuid, '00000000-0000-0000-0000-000000000001'::uuid,
 ...
 '["https://images.unsplash.com/photo-1519225421980-715cb0215aed", "https://images.unsplash.com/photo-1513475382585-d06e58bcb0e0", "https://images.unsplash.com/photo-1507525428034-b723cf961d3e"]'::jsonb,
 400.00, 'rentals@riversidegardens.com', '+1-555-0105', 'riverside-gardens', true, true),
...
('10000000-0000-0000-0000-000000000006'::uuid, '00000000-0000-0000-0000-000000000001'::uuid,
 ...
 '["https://images.unsplash.com/photo-1551698618-1dfe5d97d256", "https://images.unsplash.com/photo-1506905925346-21bda4d32df4", "https://images.unsplash.com/photo-1533174072545-7a4b6ad7a6a3"]'::jsonb,
 2000.00, 'events@mountainviewstadium.com', '+1-555-0106', 'mountain-view-stadium', true, true),
...
('10000000-0000-0000-0000-000000000007'::uuid, '00000000-0000-0000-0000-000000000001'::uuid,
 ...
 '["https://images.unsplash.com/photo-1540039155733-5bb30b53aa14", "https://images.unsplash.com/photo-1505373877841-8d25f7d46678", "https://images.unsplash.com/photo-1519167758481-83f550bb49b3"]'::jsonb,
 800.00, 'book@warehousedistrict.com', '+1-555-0107', 'warehouse-district', true, true),
...
('10000000-0000-0000-0000-000000000008'::uuid, '00000000-0000-0000-0000-000000000001'::uuid,
 ...
 '["https://images.unsplash.com/photo-1566737236500-c8ac43014a67", "https://images.unsplash.com/photo-1514525253161-7a46d19cd819", "https://images.unsplash.com/photo-1505373877841-8d25f7d46678"]'::jsonb,
 600.00, 'reservations@rooftopskylounge.com', '+1-555-0108', 'rooftop-sky-lounge', true, true),
...
('10000000-0000-0000-0000-000000000009'::uuid, '00000000-0000-0000-0000-000000000001'::uuid,
 ...
 '["https://images.unsplash.com/photo-1481627834876-b7833e8f5570", "https://images.unsplash.com/photo-1503095396549-807759245b35", "https://images.unsplash.com/photo-1531058020387-3be344556be6"]'::jsonb,
 350.00, 'events@libraryhall.com', '+1-555-0109', 'historic-library-hall', true, true),

('10000000-0000-0000-0000-000000000010'::uuid, '00000000-0000-0000-0000-000000000001'::uuid,
 ...
 '["https://images.unsplash.com/photo-1507525428034-b723cf961d3e", "https://images.unsplash.com/photo-1519225421980-715cb0215aed", "https://images.unsplash.com/photo-1533174072545-7a4b6ad7a6a3"]'::jsonb,
 900.00, 'info@beachsidepavilion.com', '+1-555-0110', 'beachside-pavilion', true, true),

('10000000-0000-0000-0000-000000000011'::uuid, '00000000-0000-0000-0000-000000000001'::uuid,
 ...
 '["https://images.unsplash.com/photo-1531058020387-3be344556be6", "https://images.unsplash.com/photo-1481627834876-b7833e8f5570", "https://images.unsplash.com/photo-1503095396549-807759245b35"]'::jsonb,
 275.00, 'gallery@artloft.com', '+1-555-0111', 'art-gallery-loft', true, true),

('10000000-0000-0000-0000-000000000012'::uuid, '00000000-0000-0000-0000-000000000001'::uuid,
 ...
 '["https://images.unsplash.com/photo-1505236858219-8359eb29e329", "https://images.unsplash.com/photo-1505373877841-8d25f7d46678", "https://images.unsplash.com/photo-1540039155733-5bb30b53aa14"]'::jsonb,
 1500.00, 'booking@conventioncenter.com', '+1-555-0112', 'convention-center-main', true, true);

-- =============================================================================
-- PERFORMERS DATA (12 records) - All with images, gallery_images, and media
-- =============================================================================

INSERT INTO public.performers (
  id, account_id, stage_name, real_name, bio, category, genres, base_rate,
  profile_image_url, gallery_images, demo_videos, audio_samples,
  booking_email, booking_phone, slug, is_verified, is_available
) VALUES
('20000000-0000-0000-0000-000000000001'::uuid, '00000000-0000-0000-0000-000000000001'::uuid,
 ...
 'https://images.unsplash.com/photo-1493225457124-a3eb161ffa5f',
 '["https://images.unsplash.com/photo-1493225457124-a3eb161ffa5f", "https://images.unsplash.com/photo-1514525253161-7a46d19cd819", "https://images.unsplash.com/photo-1571019613454-1cb2f99b2d8b"]'::jsonb,
 '["https://www.youtube.com/watch?v=dQw4w9WgXcQ", "https://www.youtube.com/watch?v=abc123xyz"]'::jsonb,
 '["https://example.com/audio1.mp3", "https://example.com/audio2.mp3"]'::jsonb,
...
('20000000-0000-0000-0000-000000000002'::uuid, '00000000-0000-0000-0000-000000000001'::uuid,
 ...
 '["https://images.unsplash.com/photo-1516280440614-37939bbacd81", "https://images.unsplash.com/photo-1493225457124-a3eb161ffa5f", "https://images.unsplash.com/photo-1580894894513-541e068a3e2b"]'::jsonb,
 '["https://www.youtube.com/watch?v=folk123", "https://www.youtube.com/watch?v=acoustic456"]'::jsonb,
 '["https://example.com/sarah1.mp3", "https://example.com/sarah2.mp3"]'::jsonb,
...
('20000000-0000-0000-0000-000000000003'::uuid, '00000000-0000-0000-0000-000000000001'::uuid,
 ...
 '["https://images.unsplash.com/photo-1571019613454-1cb2f99b2d8b", "https://images.unsplash.com/photo-1493225457124-a3eb161ffa5f", "https://images.unsplash.com/photo-1514525253161-7a46d19cd819"]'::jsonb,
 '["https://www.youtube.com/watch?v=rock789", "https://www.youtube.com/watch?v=electric012"]'::jsonb,
 '["https://example.com/storm1.mp3", "https://example.com/storm2.mp3"]'::jsonb,
...
('20000000-0000-0000-0000-000000000004'::uuid, '00000000-0000-0000-0000-000000000001'::uuid,
 ...
 '["https://images.unsplash.com/photo-1598488035139-bdbb2231ce04", "https://images.unsplash.com/photo-1571019613454-1cb2f99b2d8b", "https://images.unsplash.com/photo-1566737236500-c8ac43014a67"]'::jsonb,
 '["https://www.youtube.com/watch?v=house345", "https://www.youtube.com/watch?v=techno678"]'::jsonb,
 '["https://example.com/nightshade1.mp3", "https://example.com/nightshade2.mp3"]'::jsonb,
...
('20000000-0000-0000-0000-000000000005'::uuid, '00000000-0000-0000-0000-000000000001'::uuid,
 ...
 'https://images.unsplash.com/photo-1598488035139-bdbb2231ce04',
 '["https://images.unsplash.com/photo-1598488035139-bdbb2231ce04", "https://images.unsplash.com/photo-1516280440614-37939bbacd81", "https://images.unsplash.com/photo-1566737236500-c8ac43014a67"]'::jsonb,
 '["https://www.youtube.com/watch?v=wedding901", "https://www.youtube.com/watch?v=latin234"]'::jsonb,
 '["https://example.com/sunset1.mp3", "https://example.com/sunset2.mp3"]'::jsonb,
 'maria@sunsetvibesmusic.com', '+1-555-1005', 'dj-sunset-vibes', true, true),

('20000000-0000-0000-0000-000000000006'::uuid, '00000000-0000-0000-0000-000000000001'::uuid,
 ...
 '["https://images.unsplash.com/photo-1527224538127-2104bb71c51b", "https://images.unsplash.com/photo-1580894894513-541e068a3e2b", "https://images.unsplash.com/photo-1516975080664-ed2fc6a32937"]'::jsonb,
 '["https://www.youtube.com/watch?v=comedy567", "https://www.youtube.com/watch?v=standup890"]'::jsonb,
 '[]'::jsonb,
 'bookings@mikelaughscomedy.com', '+1-555-1006', 'mike-laughs', true, true),

('20000000-0000-0000-0000-000000000007'::uuid, '00000000-0000-0000-0000-000000000001'::uuid,
 ...
 'https://images.unsplash.com/photo-1527224538127-2104bb71c51b',
 '["https://images.unsplash.com/photo-1527224538127-2104bb71c51b", "https://images.unsplash.com/photo-1516975080664-ed2fc6a32937", "https://images.unsplash.com/photo-1580894894513-541e068a3e2b"]'::jsonb,
 '["https://www.youtube.com/watch?v=improv123", "https://www.youtube.com/watch?v=sketch456"]'::jsonb,
 '[]'::jsonb,
 'hello@comedyduoplusone.com', '+1-555-1007', 'comedy-duo-plus-one', true, true),

('20000000-0000-0000-0000-000000000008'::uuid, '00000000-0000-0000-0000-000000000001'::uuid,
 ...
 '["https://images.unsplash.com/photo-1580894894513-541e068a3e2b", "https://images.unsplash.com/photo-1516280440614-37939bbacd81", "https://images.unsplash.com/photo-1527224538127-2104bb71c51b"]'::jsonb,
 '["https://www.youtube.com/watch?v=leadership789", "https://www.youtube.com/watch?v=motivational012"]'::jsonb,
 '["https://example.com/patricia1.mp3", "https://example.com/patricia2.mp3"]'::jsonb,
 'speaking@patriciawilson.com', '+1-555-1008', 'dr-patricia-wilson', true, true),

('20000000-0000-0000-0000-000000000009'::uuid, '00000000-0000-0000-0000-000000000001'::uuid,
 ...
 '["https://images.unsplash.com/photo-1516975080664-ed2fc6a32937", "https://images.unsplash.com/photo-1527224538127-2104bb71c51b", "https://images.unsplash.com/photo-1580894894513-541e068a3e2b"]'::jsonb,
 '["https://www.youtube.com/watch?v=magic345", "https://www.youtube.com/watch?v=illusions678"]'::jsonb,
 '[]'::jsonb,
 'bookings@amazingmarco.com', '+1-555-1009', 'amazing-marco', true, true),

('20000000-0000-0000-0000-000000000010'::uuid, '00000000-0000-0000-0000-000000000001'::uuid,
 ...
 '["https://images.unsplash.com/photo-1547153760-18fc86324498", "https://images.unsplash.com/photo-1571019613454-1cb2f99b2d8b", "https://images.unsplash.com/photo-1516280440614-37939bbacd81"]'::jsonb,
 '["https://www.youtube.com/watch?v=dance901", "https://www.youtube.com/watch?v=contemporary234"]'::jsonb,
 '["https://example.com/rhythm1.mp3", "https://example.com/rhythm2.mp3"]'::jsonb,
 'bookings@rhythmsoul.com', '+1-555-1010', 'rhythm-soul-dance', true, true),

('20000000-0000-0000-0000-000000000011'::uuid, '00000000-0000-0000-0000-000000000001'::uuid,
 ...
 'https://images.unsplash.com/photo-1493225457124-a3eb161ffa5f',
 '["https://images.unsplash.com/photo-1493225457124-a3eb161ffa5f", "https://images.unsplash.com/photo-1516280440614-37939bbacd81", "https://images.unsplash.com/photo-1580894894513-541e068a3e2b"]'::jsonb,
 '["https://www.youtube.com/watch?v=violin567", "https://www.youtube.com/watch?v=classical890"]'::jsonb,
 '["https://example.com/violin1.mp3", "https://example.com/violin2.mp3"]'::jsonb,
 'anna@versatileviolinist.com', '+1-555-1011', 'versatile-violinist', true, true),

('20000000-0000-0000-0000-000000000012'::uuid, '00000000-0000-0000-0000-000000000001'::uuid,
 ...
 'https://images.unsplash.com/photo-1527224538127-2104bb71c51b',
 '["https://images.unsplash.com/photo-1527224538127-2104bb71c51b", "https://images.unsplash.com/photo-1580894894513-541e068a3e2b", "https://images.unsplash.com/photo-1516975080664-ed2fc6a32937"]'::jsonb,
 '["https://www.youtube.com/watch?v=corporate123", "https://www.youtube.com/watch?v=teambuilding456"]'::jsonb,
 '[]'::jsonb,
 'robert@corporatecomedy.com', '+1-555-1012', 'corporate-comedy-solutions', true, true);

-- =============================================================================
-- EVENTS DATA (12 records) - All with images and gallery_images
-- =============================================================================

INSERT INTO public.events (
  id, account_id, title, description, category, status, start_date, end_date,
  venue_id, image_url, gallery_images, base_price, max_capacity, 
  slug, is_featured, is_public
) VALUES
('30000000-0000-0000-0000-000000000001'::uuid, '00000000-0000-0000-0000-000000000001'::uuid,
 ...
 'https://images.unsplash.com/photo-1514525253161-7a46d19cd819',
 '["https://images.unsplash.com/photo-1514525253161-7a46d19cd819", "https://images.unsplash.com/photo-1493225457124-a3eb161ffa5f", "https://images.unsplash.com/photo-1533174072545-7a4b6ad7a6a3"]'::jsonb,
...
('30000000-0000-0000-0000-000000000002'::uuid, '00000000-0000-0000-0000-000000000001'::uuid,
 ...
 '["https://images.unsplash.com/photo-1505373877841-8d25f7d46678", "https://images.unsplash.com/photo-1540039155733-5bb30b53aa14", "https://images.unsplash.com/photo-1580894894513-541e068a3e2b"]'::jsonb,
...
('30000000-0000-0000-0000-000000000003'::uuid, '00000000-0000-0000-0000-000000000001'::uuid,
 ...
 'https://images.unsplash.com/photo-1516280440614-37939bbacd81',
 '["https://images.unsplash.com/photo-1516280440614-37939bbacd81", "https://images.unsplash.com/photo-1493225457124-a3eb161ffa5f", "https://images.unsplash.com/photo-1514525253161-7a46d19cd819"]'::jsonb,
 25.00, 150, 'acoustic-nights-sarah-martinez', true, true),

('30000000-0000-0000-0000-000000000004'::uuid, '00000000-0000-0000-0000-000000000001'::uuid,
 ...
 'https://images.unsplash.com/photo-1527224538127-2104bb71c51b',
 '["https://images.unsplash.com/photo-1527224538127-2104bb71c51b", "https://images.unsplash.com/photo-1516975080664-ed2fc6a32937", "https://images.unsplash.com/photo-1503095396549-807759245b35"]'::jsonb,
 20.00, 400, 'comedy-night-spectacular', true, true),

('30000000-0000-0000-0000-000000000005'::uuid, '00000000-0000-0000-0000-000000000001'::uuid,
 ...
 'https://images.unsplash.com/photo-1571019613454-1cb2f99b2d8b',
 '["https://images.unsplash.com/photo-1571019613454-1cb2f99b2d8b", "https://images.unsplash.com/photo-1551698618-1dfe5d97d256", "https://images.unsplash.com/photo-1533174072545-7a4b6ad7a6a3"]'::jsonb,
 55.00, 5000, 'electric-storm-rock-concert', true, true),

('30000000-0000-0000-0000-000000000006'::uuid, '00000000-0000-0000-0000-000000000001'::uuid,
...
('30000000-0000-0000-0000-000000000007'::uuid, '00000000-0000-0000-0000-000000000001'::uuid,
...
('30000000-0000-0000-0000-000000000008'::uuid, '00000000-0000-0000-0000-000000000001'::uuid,
 ...
 'https://images.unsplash.com/photo-1580894894513-541e068a3e2b',
 '["https://images.unsplash.com/photo-1580894894513-541e068a3e2b", "https://images.unsplash.com/photo-1481627834876-b7833e8f5570", "https://images.unsplash.com/photo-1505373877841-8d25f7d46678"]'::jsonb,
 199.00, 50, 'leadership-workshop-dr-wilson', false, true),

('30000000-0000-0000-0000-000000000009'::uuid, '00000000-0000-0000-0000-000000000001'::uuid,
 'Rooftop Dance Party',
 ...
 'https://images.unsplash.com/photo-1566737236500-c8ac43014a67',
 '["https://images.unsplash.com/photo-1566737236500-c8ac43014a67", "https://images.unsplash.com/photo-1598488035139-bdbb2231ce04", "https://images.unsplash.com/photo-1571019613454-1cb2f99b2d8b"]'::jsonb,
 30.00, 200, 'rooftop-dance-party', false, true),

('30000000-0000-0000-0000-000000000010'::uuid, '00000000-0000-0000-0000-000000000001'::uuid,
 'Magic & Wonder Show',
 ...
 'https://images.unsplash.com/photo-1516975080664-ed2fc6a32937',
 '["https://images.unsplash.com/photo-1516975080664-ed2fc6a32937", "https://images.unsplash.com/photo-1527224538127-2104bb71c51b", "https://images.unsplash.com/photo-1519167758481-83f550bb49b3"]'::jsonb,
 15.00, 300, 'magic-wonder-show', false, true),

('30000000-0000-0000-0000-000000000011'::uuid, '00000000-0000-0000-0000-000000000001'::uuid,
...
('30000000-0000-0000-0000-000000000012'::uuid, '00000000-0000-0000-0000-000000000001'::uuid,
 ...
 'https://images.unsplash.com/photo-1505373877841-8d25f7d46678',
 '["https://images.unsplash.com/photo-1505373877841-8d25f7d46678", "https://images.unsplash.com/photo-1540039155733-5bb30b53aa14", "https://images.unsplash.com/photo-1549924231-f129b911e442"]'::jsonb,
 75.00, 500, 'tech-innovation-showcase', false, true);

-- =============================================================================
-- COMMUNITY HUBS DATA (12 records) - All with logo_url and banner_url
-- =============================================================================
...
('40000000-0000-0000-0000-000000000010'::uuid, '00000000-0000-0000-0000-000000000001'::uuid,
...
('40000000-0000-0000-0000-000000000011'::uuid, '00000000-0000-0000-0000-000000000001'::uuid,
...
('40000000-0000-0000-0000-000000000012'::uuid, '00000000-0000-0000-0000-000000000001'::uuid,
...
('50000000-0000-0000-0000-000000000004'::uuid, '00000000-0000-0000-0000-000000000001'::uuid,
...
('50000000-0000-0000-0000-000000000005'::uuid, '00000000-0000-0000-0000-000000000001'::uuid,
...
('50000000-0000-0000-0000-000000000006'::uuid, '00000000-0000-0000-0000-000000000001'::uuid,
...
('50000000-0000-0000-0000-000000000007'::uuid, '00000000-0000-0000-0000-000000000001'::uuid,
...
('50000000-0000-0000-0000-000000000008'::uuid, '00000000-0000-0000-0000-000000000001'::uuid,
...
('50000000-0000-0000-0000-000000000009'::uuid, '00000000-0000-0000-0000-000000000001'::uuid,
...
('50000000-0000-0000-0000-000000000010'::uuid, '00000000-0000-0000-0000-000000000001'::uuid,
...
('50000000-0000-0000-0000-000000000011'::uuid, '00000000-0000-0000-0000-000000000001'::uuid,
...
('50000000-0000-0000-0000-000000000012'::uuid, '00000000-0000-0000-0000-000000000001'::uuid,
...
-- =============================================================================
-- REVIEWS DATA (12 records) - With images where applicable  
-- =============================================================================

INSERT INTO public.reviews (
  id, account_id, entity_type, entity_id, rating, title, content, images, is_verified
) VALUES
('60000000-0000-0000-0000-000000000001'::uuid, '00000000-0000-0000-0000-000000000001'::uuid,
 ...
 'The Grand Theatre exceeded all expectations. The acoustics are incredible and the staff was professional throughout. Perfect for our corporate event.',
 '["https://images.unsplash.com/photo-1514525253161-7a46d19cd819", "https://images.unsplash.com/photo-1503095396549-807759245b35"]'::jsonb, true),
...
('60000000-0000-0000-0000-000000000002'::uuid, '00000000-0000-0000-0000-000000000001'::uuid,
 ...
 'These musicians are absolutely top-tier. Their performance at our festival was the highlight of the weekend. Professional, talented, and engaging with the audience.',
 '["https://images.unsplash.com/photo-1493225457124-a3eb161ffa5f"]'::jsonb, true),
...
('60000000-0000-0000-0000-000000000003'::uuid, '00000000-0000-0000-0000-000000000001'::uuid,
 ...
 'The music was fantastic and the venue was beautiful. Food options were good too. Only complaint is the entry process was a bit slow, but overall a wonderful experience.',
 '["https://images.unsplash.com/photo-1514525253161-7a46d19cd819", "https://images.unsplash.com/photo-1533174072545-7a4b6ad7a6a3"]'::jsonb, true),

('60000000-0000-0000-0000-000000000004'::uuid, '00000000-0000-0000-0000-000000000001'::uuid,
 'venue', '10000000-0000-0000-0000-000000000002'::uuid, 5,
 'Perfect intimate venue',
 'Blue Note Jazz Club is exactly what you want for an intimate performance. Great atmosphere, excellent sound system, and the staff knows their jazz!',
 '["https://images.unsplash.com/photo-1493225457124-a3eb161ffa5f"]'::jsonb, true),

('60000000-0000-0000-0000-000000000005'::uuid, '00000000-0000-0000-0000-000000000001'::uuid,
 'performer', '20000000-0000-0000-0000-000000000002'::uuid, 4,
 'Beautiful voice and great stage presence',
 'Sarah Martinez delivered a heartfelt performance. Her original songs were beautiful and she had great interaction with the audience. Would definitely book again.',
 '["https://images.unsplash.com/photo-1516280440614-37939bbacd81"]'::jsonb, true),

('60000000-0000-0000-0000-000000000006'::uuid, '00000000-0000-0000-0000-000000000001'::uuid,
 'venue', '10000000-0000-0000-0000-000000000004'::uuid, 5,
 'Amazing outdoor venue!',
 'Sunset Amphitheater is breathtaking. The sunset views during the performance were incredible. Well-organized event with great facilities.',
 '["https://images.unsplash.com/photo-1533174072545-7a4b6ad7a6a3", "https://images.unsplash.com/photo-1506905925346-21bda4d32df4"]'::jsonb, true),

('60000000-0000-0000-0000-000000000007'::uuid, '00000000-0000-0000-0000-000000000001'::uuid,
 'performer', '20000000-0000-0000-0000-000000000006'::uuid, 5,
 'Hilarious and professional',
 'Mike Laughs had our corporate event in stitches. Clean comedy that was appropriate for all ages. Very professional and easy to work with.',
 '[]'::jsonb, true),

('60000000-0000-0000-0000-000000000008'::uuid, '00000000-0000-0000-0000-000000000001'::uuid,
 'event', '30000000-0000-0000-0000-000000000003'::uuid, 5,
 'Magical intimate evening',
 'This acoustic night was perfect. Small venue, great artist, amazing atmosphere. Sarah''s performance was captivating from start to finish.',
 '["https://images.unsplash.com/photo-1516280440614-37939bbacd81", "https://images.unsplash.com/photo-1493225457124-a3eb161ffa5f"]'::jsonb, true),

('60000000-0000-0000-0000-000000000009'::uuid, '00000000-0000-0000-0000-000000000001'::uuid,
 'venue', '10000000-0000-0000-0000-000000000008'::uuid, 4,
 'Great rooftop experience',
 'Rooftop Sky Lounge has amazing views and a great setup for parties. The only downside was it got a bit crowded, but that''s expected for popular events.',
 '["https://images.unsplash.com/photo-1566737236500-c8ac43014a67"]'::jsonb, true),

('60000000-0000-0000-0000-000000000010'::uuid, '00000000-0000-0000-0000-000000000001'::uuid,
 'performer', '20000000-0000-0000-0000-000000000004'::uuid, 4,
 'DJ Nightshade knows how to move a crowd',
 'Great music selection and excellent crowd reading skills. The energy was high all night. Would definitely have him back for future events.',
 '["https://images.unsplash.com/photo-1598488035139-bdbb2231ce04"]'::jsonb, true),

('60000000-0000-0000-0000-000000000011'::uuid, '00000000-0000-0000-0000-000000000001'::uuid,
 'venue', '10000000-0000-0000-0000-000000000011'::uuid, 5,
 'Unique and beautiful space',
 'Art Gallery Loft provided the perfect setting for our art exhibition opening. The space is flexible and the lighting is perfect for showcasing artwork.',
 '["https://images.unsplash.com/photo-1531058020387-3be344556be6"]'::jsonb, true),

('60000000-0000-0000-0000-000000000012'::uuid, '00000000-0000-0000-0000-000000000001'::uuid,
 'performer', '20000000-0000-0000-0000-000000000009'::uuid, 5,
 'Amazing Marco lived up to his name!',
 'The magic show was incredible. Amazing Marco kept both kids and adults entertained throughout. Professional setup and truly impressive illusions.',
 '["https://images.unsplash.com/photo-1516975080664-ed2fc6a32937"]'::jsonb, true);

-- =============================================================================
-- MESSAGES DATA (12 records)
-- =============================================================================

-- Note: Using dummy user IDs since we may not have auth.users populated
...
('70000000-0000-0000-0000-000000000001'::uuid, 
 ...
 COALESCE((SELECT id FROM auth.users OFFSET 1 LIMIT 1), '00000000-0000-0000-0000-000000000001'::uuid),
...
('80000000-0000-0000-0000-000000000001'::uuid, '00000000-0000-0000-0000-000000000001'::uuid,
 'venue', '10000000-0000-0000-0000-000000000001'::uuid),

('80000000-0000-0000-0000-000000000002'::uuid, '00000000-0000-0000-0000-000000000001'::uuid,
 'performer', '20000000-0000-0000-0000-000000000001'::uuid),

('80000000-0000-0000-0000-000000000003'::uuid, '00000000-0000-0000-0000-000000000001'::uuid,
 'event', '30000000-0000-0000-0000-000000000001'::uuid),

('80000000-0000-0000-0000-000000000004'::uuid, '00000000-0000-0000-0000-000000000001'::uuid,
 'venue', '10000000-0000-0000-0000-000000000004'::uuid),

('80000000-0000-0000-0000-000000000005'::uuid, '00000000-0000-0000-0000-000000000001'::uuid,
 'performer', '20000000-0000-0000-0000-000000000002'::uuid),

('80000000-0000-0000-0000-000000000006'::uuid, '00000000-0000-0000-0000-000000000001'::uuid,
 'hub', '40000000-0000-0000-0000-000000000001'::uuid),

('80000000-0000-0000-0000-000000000007'::uuid, '00000000-0000-0000-0000-000000000001'::uuid,
 'venue', '10000000-0000-0000-0000-000000000008'::uuid),

('80000000-0000-0000-0000-000000000008'::uuid, '00000000-0000-0000-0000-000000000001'::uuid,
 'event', '30000000-0000-0000-0000-000000000007'::uuid),

('80000000-0000-0000-0000-000000000009'::uuid, '00000000-0000-0000-0000-000000000001'::uuid,
 'performer', '20000000-0000-0000-0000-000000000009'::uuid),

('80000000-0000-0000-0000-000000000010'::uuid, '00000000-0000-0000-0000-000000000001'::uuid,
 'venue', '10000000-0000-0000-0000-000000000011'::uuid),

('80000000-0000-0000-0000-000000000011'::uuid, '00000000-0000-0000-0000-000000000001'::uuid,
 'hub', '40000000-0000-0000-0000-000000000003'::uuid),

('80000000-0000-0000-0000-000000000012'::uuid, '00000000-0000-0000-0000-000000000001'::uuid,
...
('90000000-0000-0000-0000-000000000001'::uuid, '40000000-0000-0000-0000-000000000001'::uuid, COALESCE((SELECT id FROM auth.users LIMIT 1), '00000000-0000-0000-0000-000000000001'::uuid), 'admin', true),
('90000000-0000-0000-0000-000000000002'::uuid, '40000000-0000-0000-0000-000000000002'::uuid, COALESCE((SELECT id FROM auth.users LIMIT 1), '00000000-0000-0000-0000-000000000001'::uuid), 'moderator', true),
('90000000-0000-0000-0000-000000000003'::uuid, '40000000-0000-0000-0000-000000000003'::uuid, COALESCE((SELECT id FROM auth.users LIMIT 1), '00000000-0000-0000-0000-000000000001'::uuid), 'member', true),
('90000000-0000-0000-0000-000000000004'::uuid, '40000000-0000-0000-0000-000000000004'::uuid, COALESCE((SELECT id FROM auth.users LIMIT 1), '00000000-0000-0000-0000-000000000001'::uuid), 'member', true),
('90000000-0000-0000-0000-000000000005'::uuid, '40000000-0000-0000-0000-000000000005'::uuid, COALESCE((SELECT id FROM auth.users LIMIT 1), '00000000-0000-0000-0000-000000000001'::uuid), 'member', true),
('90000000-0000-0000-0000-000000000006'::uuid, '40000000-0000-0000-0000-000000000006'::uuid, COALESCE((SELECT id FROM auth.users LIMIT 1), '00000000-0000-0000-0000-000000000001'::uuid), 'member', true),
('90000000-0000-0000-0000-000000000007'::uuid, '40000000-0000-0000-0000-000000000007'::uuid, COALESCE((SELECT id FROM auth.users LIMIT 1), '00000000-0000-0000-0000-000000000001'::uuid), 'member', true),
('90000000-0000-0000-0000-000000000008'::uuid, '40000000-0000-0000-0000-000000000008'::uuid, COALESCE((SELECT id FROM auth.users LIMIT 1), '00000000-0000-0000-0000-000000000001'::uuid), 'member', true),
('90000000-0000-0000-0000-000000000009'::uuid, '40000000-0000-0000-0000-000000000009'::uuid, COALESCE((SELECT id FROM auth.users LIMIT 1), '00000000-0000-0000-0000-000000000001'::uuid), 'member', true),
('90000000-0000-0000-0000-000000000010'::uuid, '40000000-0000-0000-0000-000000000010'::uuid, COALESCE((SELECT id FROM auth.users LIMIT 1), '00000000-0000-0000-0000-000000000001'::uuid), 'member', true),
('90000000-0000-0000-0000-000000000011'::uuid, '40000000-0000-0000-0000-000000000011'::uuid, COALESCE((SELECT id FROM auth.users LIMIT 1), '00000000-0000-0000-0000-000000000001'::uuid), 'member', true),
('90000000-0000-0000-0000-000000000012'::uuid, '40000000-0000-0000-0000-000000000012'::uuid, COALESCE((SELECT id FROM auth.users LIMIT 1), '00000000-0000-0000-0000-000000000001'::uuid), 'admin', true);
...
('A0000000-0000-0000-0000-000000000001'::uuid, COALESCE((SELECT id FROM auth.users OFFSET 0 LIMIT 1), 'A1000000-0000-0000-0000-000000000001'::uuid),
...
-- =============================================================================
-- EVENT ANALYTICS DATA (12 records)
-- =============================================================================
...
-- =============================================================================
-- UPDATE RELATIONSHIP STATS & COMPLETION MESSAGE
-- =============================================================================
...
BEGIN
  ...
  RAISE NOTICE '12 records inserted for EVERY table:';
  RAISE NOTICE '✓ Venues (with images & gallery_images)';
  RAISE NOTICE '✓ Performers (with profile_image, gallery_images, demo_videos, audio_samples)';
  RAISE NOTICE '✓ Events (with image_url & gallery_images)';
  RAISE NOTICE '✓ Community Hubs (with logo_url & banner_url)';
  RAISE NOTICE '✓ Bookings';
  RAISE NOTICE '✓ Reviews (with images where applicable)';
  RAISE NOTICE '✓ Messages';
  RAISE NOTICE '✓ Favorites';
  RAISE NOTICE '✓ Hub Memberships';
  RAISE NOTICE '✓ User Preferences';
  RAISE NOTICE '✓ Event Analytics';
  RAISE NOTICE '';
  RAISE NOTICE 'All relationship stats have been updated.';
