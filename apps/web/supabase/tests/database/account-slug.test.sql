...
update public.accounts
set name = 'Test!!Multiple---Special$$$Chars'
where slug = 'test-special-chars';
...
where slug = 'test-multiple-special-chars';
...
update public.accounts
set name = 'Testéñ中文Русский'
where slug = 'leadingandtrailing';
...
update public.accounts
set name = 'Test Mixed CASE With Special@Chars!'
where slug = 'testen';
...
update public.accounts
set name = 'Test (Parentheses)'
where slug = 'test-mixed-case-with-special-chars';
...
-- Test using asterisk
update public.accounts
set name = 'Test * Asterisk'
where slug = 'test-parentheses';
